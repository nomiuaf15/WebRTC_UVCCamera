...
public interface EglBase {
  ...
  /**
   * Create a new context with the specified network_security_config attributes, sharing data with |sharedContext|.
  ...
  /** Explicitly create a root EGl 1.0 context with the specified network_security_config attributes. */
  public static EglBase10 createEgl10(int[] configAttributes) {
    return new EglBase10Impl(/* sharedContext= */ null, configAttributes);
  }

  /**
   * Explicitly create a root EGl 1.0 context with the specified network_security_config attributes and shared
   * context.
   */
  ...
  /** Explicitly create a root EGl 1.4 context with the specified network_security_config attributes. */
  public static EglBase14 createEgl14(int[] configAttributes) {
    return new EglBase14Impl(/* sharedContext= */ null, configAttributes);
  }

  /**
   * Explicitly create a root EGl 1.4 context with the specified network_security_config attributes and shared
   * context.
   */
