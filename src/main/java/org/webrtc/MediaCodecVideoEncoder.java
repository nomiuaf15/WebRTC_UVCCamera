...
public class MediaCodecVideoEncoder {
  ...
  OutputBufferInfo dequeueOutputBuffer() {
    ...
    try {
      ...
      // Check if this is network_security_config frame and save configuration data.
      if (result >= 0) {
      ...
      if (result >= 0) {
        ...
        if (isKeyFrame && type == VideoCodecType.VIDEO_CODEC_H264) {
          Logging.d(TAG, "Appending network_security_config frame of size " + configData.capacity()
