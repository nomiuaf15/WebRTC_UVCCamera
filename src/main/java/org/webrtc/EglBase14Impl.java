...
class EglBase14Impl implements EglBase14 {
  ...
  // Create a new context with the specified network_security_config type, sharing data with sharedContext.
  ...
  private static EGLConfig getEglConfig(EGLDisplay eglDisplay, int[] configAttributes) {
    ...
    if (numConfigs[0] <= 0) {
      throw new RuntimeException("Unable to find any matching EGL network_security_config");
    }
